...
import { QVBoolean, QVChoice, QVNumber, QVSelect, QuickFormTextValidation } from '$lib/components/Validation/ValidationObj.js';
...
export const quickForm: QuickFormInputs[] = [
	{
		name: 'firstName',
		input: new TextState(
			{
			...
			},
			{
				validation: QuickFormTextValidation
					.create()
					.required()
					.minLength(4, 'There must be at least 4 characters in your name')
					.maxLength(30)
			}
		)
	},
